(() => {
    ...
    map: function(v) {
      return function(v1) {
        if (v1 instanceof Handler) {
          return new Handler(v1.value0, map6(map12(v))(v1.value1));
        }
        ;
        if (v1 instanceof Ref) {
          return new Ref(map6(map12(v))(v1.value0));
        }
        ;
        return v1;
      };
  ...
  var bifunctorHTML = {
    bimap: function(f) {
      return function(g) {
        return function(v) {
          return bimap3(map7(map13(map22(g))))(f)(v);
        };
      };
    }
  };
  ...
  // output/Comptes.Component.Part.Button/index.js
  var map8 = /* @__PURE__ */ map(functorArray);
  var button2 = function(v) {
    return button([classes(map8(ClassName)(cons("button")(v.classNames))), onClick(function(v1) {
      return v.action;
    })])([text(v.label)]);
  };

  // output/Comptes.Store/index.js
  ...
  var Decrement = /* @__PURE__ */ function() {
    ...
    ;
    Decrement3.value = new Decrement3();
    return Decrement3;
  }();
  var reduce = function(store) {
    return function(action2) {
      return {
        ...
        counter: {
          counterActions: new Cons(action2, store.counter.counterActions)
        }
      };
    };
  };
  ...
  var eqAction = {
    eq: function(x) {
      return function(y) {
        ...
        ;
        if (x instanceof Decrement && y instanceof Decrement) {
          return true;
        }
        ;
        return false;
  ...
  var substFree = function(k) {
    var go2 = function(f) {
      ...
      if (v instanceof Bind) {
        return bind2(k(v.value0))(map9(go2)(v.value1));
      }
      ;
      ...
      return function(reducer) {
        return function(component3) {
          return map16(function(v) {
            return v.component;
          })(runAndEmitStoreT1(initialStore)(reducer)(component3));
        };
      };
    };
  };
  ...
  var subscribe3 = function(dictMonadStore) {
    ...
    return function(selector) {
      return function(action2) {
        return bind4(emitSelected2(selector))(function(emitter) {
          return $$void5(subscribe2(map17(action2)(emitter)));
        });
      };
    };
  };
        ...
        return function(component3) {
          var renderInner = function(input3) {
            return function(context) {
              return slot2($$Proxy.value)(unit)(component3)({
                input: input3,
                context
              })(Raise2.create);
            };
          ...
          var handleAction2 = function(v1) {
            if (v1 instanceof Initialize2) {
              return discard2(subscribe1(v)(Update.create))(function() {
                return bind4(map18(v.select)(getStore2))(function(context) {
            ...
            if (v1 instanceof Receive2) {
              return bind4(gets2(function(v2) {
                return v2.input;
              }))(function(oldInput) {
  ...
  var selectEq2 = /* @__PURE__ */ selectEq(/* @__PURE__ */ eqMaybe(/* @__PURE__ */ eqRec2(/* @__PURE__ */ eqRowCons(/* @__PURE__ */ eqRowCons2({
    reflectSymbol: function() {
      return "logLevel";
    }
  })(eqLogLevel))()({
  ...
  })(/* @__PURE__ */ eqRec2(/* @__PURE__ */ eqRowCons2({
    reflectSymbol: function() {
      return "counterActions";
    }
  })(/* @__PURE__ */ eqList(eqAction)))))));
  ...
  var Increment2 = /* @__PURE__ */ function() {
    function Increment3() {
    }
    ;
    Increment3.value = new Increment3();
  ...
  var Decrement2 = /* @__PURE__ */ function() {
    function Decrement3() {
    }
    ;
    Decrement3.value = new Decrement3();
  ...
  var render = function(state3) {
    return div2([classes(["button-container"])])([p_([text("Count is: " + show2(state3.count))]), button2({
      label: "Increment",
      action: Increment2.value,
      classNames: ["increment"]
    }), button2({
      label: "Decrement",
      action: Decrement2.value,
      classNames: ["decrement"]
    })]);
  };
  var calculateResult = function($copy_n) {
    return function($copy_actions) {
      var $tco_var_n = $copy_n;
      var $tco_done = false;
      var $tco_result;
      function $tco_loop(n, actions) {
        if (actions instanceof Nil) {
          $tco_done = true;
          return n;
        }
        ;
        if (actions instanceof Cons && actions.value0 instanceof Increment) {
          $tco_var_n = n + 1 | 0;
          $copy_actions = actions.value1;
          return;
        }
        ;
        if (actions instanceof Cons && actions.value0 instanceof Decrement) {
          $tco_var_n = n - 1 | 0;
          $copy_actions = actions.value1;
          return;
        }
        ;
        throw new Error("Failed pattern match at App.Button (line 57, column 29 - line 60, column 52): " + [actions.constructor.name]);
      }
      ;
      while (!$tco_done) {
        $tco_result = $tco_loop($tco_var_n, $copy_actions);
      }
      ;
      return $tco_result;
    };
  ...
  var count = function(v) {
    return calculateResult(0)(v.counter.counterActions);
  };
  var handleAction = function(dictMonadState) {
    var modify_4 = modify_2(dictMonadState);
    return function(dictMonadStore) {
      var updateStore2 = updateStore(dictMonadStore);
      return function(v) {
        ...
        if (v instanceof Receive3) {
          if (v.value0.context instanceof Just) {
            return modify_4(function(st) {
              var $55 = {};
              for (var $56 in st) {
              ...
              ;
              $55.count = count(v.value0.context.value0);
              return $55;
            });
          }
          ;
          if (v.value0.context instanceof Nothing) {
            return modify_4(function(s) {
              return s;
            });
          }
          ;
          throw new Error("Failed pattern match at App.Button (line 82, column 38 - line 84, column 33): " + [v.value0.context.constructor.name]);
        }
        ;
        if (v instanceof Increment2) {
          return updateStore2(Increment.value);
        }
        ;
        if (v instanceof Decrement2) {
          return updateStore2(Decrement.value);
        }
        ;
        throw new Error("Failed pattern match at App.Button (line 80, column 16 - line 86, column 40): " + [v.constructor.name]);
      };
    };
  };
  var handleAction1 = /* @__PURE__ */ handleAction(monadStateHalogenM);
  var component = function(dictMonadStore) {
    return connect(dictMonadStore.MonadEffect0())(dictMonadStore)(selectEq2(pure6))(mkComponent({
      ...
      render,
      "eval": mkEval({
        handleAction: handleAction1(monadStoreHalogenM(dictMonadStore)),
        handleQuery: defaultEval.handleQuery,
        receive: function($61) {
          return Just.create(Receive3.create($61));
        },
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element3) {
        return bind15(liftEffect7(map26(toDocument)(bindFlipped7(document)(windowImpl))))(function(document2) {
  ...
  var component2 = /* @__PURE__ */ component(monadStoreAppM);
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind7(awaitBody)(function(body2) {
    var initialStore = {
      logLevel: Dev.value,
      counter: {
        counterActions: Nil.value
      }
    };
    return bind7(runAppM(initialStore)(component2))(function(rootComponent) {
      return runUI2(rootComponent)(unit)(body2);
    });
  }));
